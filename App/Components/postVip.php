<div class="right_title">BÀI VIẾT PHỔ BIẾN</div>
<div class="right_body">
    <ul>
        <? foreach ($posts_see as $post) { ?>
            <li>
                <div class="right_item">
                    <a href="/post/detail/<? echo $post['id'] ?>" class="right_item_title"><? echo $post['title'] ?> <span class="item_time"><? echo date('M d, Y', strtotime($post['createAt'])) ?></span></a>
